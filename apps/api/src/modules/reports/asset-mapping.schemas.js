...
const NullableOrgObj = Type.Union([
  Type.Object({
    code: Type.String(),
    label: Type.String(),
  }),
...
const NullableIdentityObj = Type.Union([
  Type.Object({
    id: Type.Integer(),
    name: Type.String(),
...
export const AssetMappingSummaryQuery = Type.Object({
  q: Type.Optional(Type.String()),
  type_code: Type.Optional(Type.String()),
  status: Type.Optional(Type.String()),
  lifecycle_state: Type.Optional(Type.String()),
...
export const AssetMappingItem = Type.Object({
  ...
  department: NullableOrgObj,
  location: NullableOrgObj,
  owner_identity: NullableIdentityObj,
...
export const AssetMappingListResponse = Type.Object({
  ok: Type.Boolean(),
  data: Type.Object({
    items: Type.Array(AssetMappingItem),
    page: Type.Integer(),
...
export const AssetMappingSummaryResponse = Type.Object({
  ok: Type.Boolean(),
  data: Type.Object({
    total_rows: Type.Integer(),
    rows_with_department: Type.Integer(),
    rows_with_location: Type.Integer(),
    rows_with_owner: Type.Integer(),
