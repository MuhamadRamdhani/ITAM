  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-3xl border border-white bg-white p-5 shadow-[0_16px_50px_rgba(15,23,42,0.08)]">
        ...
        <form onSubmit={onCreateIdentity} className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
          <div>
      ...
      <div className="rounded-3xl border border-white bg-white p-5 shadow-[0_16px_50px_rgba(15,23,42,0.08)]">
        ...
        <div className="mt-5 flex items-start justify-between gap-4">
          ...
          <div className="text-xs text-slate-500">Tip: custodian aset pada model ITAM Anda mengacu ke identity.</div>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {listLoading ? (
                ...
                data.items.map((i) => (
                  <tr key={String(i.id)} className="border-t border-slate-100">
                    <td className="py-4 pr-4 text-slate-800">{i.name}</td>
                    <td className="py-4 pr-4 text-slate-700">{i.email || "-"}</td>
                    <td className="py-4 pr-4 text-slate-700">{i.department_name || "-"}</td>
