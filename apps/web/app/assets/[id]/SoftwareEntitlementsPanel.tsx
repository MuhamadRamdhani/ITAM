...
export default function SoftwareEntitlementsPanel({
  ...
  }, [loadComplianceSummary, loadEntitlements]);

  const refreshPanel = useCallback(async () => {
    await Promise.all([loadEntitlements(), loadComplianceSummary()]);
  }, [loadComplianceSummary, loadEntitlements]);
                  ...
                  <tr key={item.id} className="align-top">
                    <td className="px-4 py-3">
                      ...
                      <div className="mt-2 text-xs text-gray-500">
                        Start: {formatDate(item.start_date)} · End:{" "}
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="mt-2 text-xs text-gray-500">
                        Publisher: {item.publisher_vendor_name || "-"}
                      </div>
                    </td>
