...
const CATEGORY_OPTIONS = ["ALL", "INTERNAL", "REGULATOR", "VENDOR", "CUSTOMER", "PARTNER", "EXTERNAL"] as const;
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Governance Stakeholders</h1>
