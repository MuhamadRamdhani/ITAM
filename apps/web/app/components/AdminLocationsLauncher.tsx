...
export default function AdminLocationsLauncher() {
  ...
  return (
    ...
    >
      <div className="text-lg font-semibold tracking-tight text-slate-900">Locations</div>
      <div className="mt-2 text-sm leading-6 text-slate-600">
        Tenant location master data
      </div>
