...
export default function AdminDepartmentsLauncher() {
  ...
  return (
    ...
    >
      <div className="text-lg font-semibold tracking-tight text-slate-900">Departments</div>
      <div className="mt-2 text-sm leading-6 text-slate-600">
        Tenant department master data
      </div>
