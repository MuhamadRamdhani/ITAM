...
export default function AdminLifecycleStatesLauncher() {
  ...
  return (
    ...
    >
      <div className="text-lg font-semibold tracking-tight text-slate-900">Lifecycle States</div>
      <div className="mt-2 text-sm leading-6 text-slate-600">
        Editable labels for lifecycle state masters
      </div>
