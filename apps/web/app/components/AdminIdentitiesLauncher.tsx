...
export default function AdminIdentitiesLauncher() {
  ...
  return (
    ...
    >
      <div className="text-lg font-semibold tracking-tight text-slate-900">Identities</div>
      <div className="mt-2 text-sm leading-6 text-slate-600">
        Tenant identity / custodian master data
      </div>
